    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header border-0">
                <div>
                    <h5 class="modal-title fw-semibold" id="filePickerModalLabel">Pilih Gambar Buku</h5>
                    <p class="text-muted mb-0">Klik tombol "Gunakan" untuk mengaitkan gambar ke buku.</p>
                </div>
            ...
            <div class="modal-body">
                <form id="modalUploadForm" class="border rounded-4 p-3 mb-4" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="folder" value="gambar-buku">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                function openPreview(url, name) {
                    ...
                    if (previewName) previewName.textContent = name || 'Pratinjau gambar';
